...
window.onload = function () {
  ...
  Swal.fire(
    "도시락통 클론코딩",
    "본 사이트는 스터디용으로 제작하였으며 리소스는 원저작자에게 있습니다. 문제 시 즉시 삭제하겠습니다."
  );

  // Waypoint 활용
  let goTop = document.querySelector(".gotop");

  // 스크롤의 위치에 따른 div 비교 대상
  ...
  fetch("data.json")
    ...
    .then((data) => {
      ...
      // 데이터 로딩 후 데이터 개수만큼 li 태그를 만든다
      // 만들어진 글자를 모아서 swUl 태그 안쪼에 innerHTML 한다
      let html = "";
      let count = 1;
